            ...
            <div class="card-body">
                ...
                <form action="" id="change-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control form" placeholder="Enter New Password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                    </div>
                    <div class="form-group">
                        <label for="" class="control-label">Confirm Password</label>
                        <input type="cpassword" class="form-control form" placeholder="Enter Confirm Password" name="cpassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                    </div>
