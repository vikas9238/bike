...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST['firstname']) && !empty($_POST['lastname']) && !empty($_POST['email']) && !empty($_POST['reason'])) {
    ...
    try {
        ...
        $mail->Subject = 'Account As Been Rejected';
    ...
    <div style='background-color: #fff;margin: 0 auto;padding: 20px;max-width: 600px;border: 1px solid #ddd;'>
        ...
        <div style='padding: 20px;'>
            <h2>Account As Been Blocked</h2>
            <p style='font-size: 14px;line-height: 1.6;'>Dear $firstname $lastname,</p>
            <p style='font-size: 14px;line-height: 1.6;'>We regret to inform you that your account with Bike Rental Service was Blocked.</p>
            <p style='font-size: 14px;line-height: 1.6;'>Upon review, we identified the following reason(s) for Blocking:</p>
            $reason<br>
